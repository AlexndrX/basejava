...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullName) {
        ...
        contact.put(ContactType.PHONE, "+7(921) 855-04-82");
        ...
        contact.put(ContactType.STACKOVERFLOW, "https://stackoverflow.com/users/548473/grigory-kislin");
        ...
        sections.put(SectionType.OBJECTIVE, text1);
        sections.put(SectionType.PERSONAL, text2);
        sections.put(SectionType.ACHIEVEMENT, list1);
        sections.put(SectionType.QUALIFICATIONS, list2);
        sections.put(SectionType.EXPERIENCE, orgSection1);
        sections.put(SectionType.EDUCATION, orgSection2);
